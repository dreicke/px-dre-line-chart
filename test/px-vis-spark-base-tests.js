...
function runBaseTests() {
  px_vis_spark_1 = document.getElementById('px_vis_spark_1');

  suite('Base Automation Tests for px-vis-spark', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-spark fixture is created', function() {
